...
//修改安全密码
public class ChangeSafePswdActivity extends BaseMvpActivity<presenter> implements Contract.Iview {
    ...
    @Override
    public int getView() {
        return R.layout.activity_change_safe_pswd;
    }
    ...
    public void getData(Object object) {
            if (object instanceof SafeBean){
                SafeBean safeBean= (SafeBean) object;
                if (safeBean.error.equals("0")){
                    Toast.makeText(mContext,"修改成功",Toast.LENGTH_SHORT).show();
                    finish();
                }else{
                    Toast.makeText(mContext,safeBean.msg,Toast.LENGTH_SHORT).show();
                }
            }
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_change:
                ...
                mPresenter.postData(UserApi.getUPSafe,headmap,map,SafeBean.class);
                break;
        }
    }
}
